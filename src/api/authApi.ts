...
const AuthOptionsSchema = z.object({
  /**
   * Server `AUTH_MODE` (`local` | `oidc` | `both`), informational only — the flags below drive the
   * UI. Kept a free string so a future mode never makes `/me` unparseable (review finding).
   */
