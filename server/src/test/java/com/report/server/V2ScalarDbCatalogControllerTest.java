...
/**
 * Unit tests for {@link V2ScalarDbCatalogController}.
 *
 * <p>Uses the hand-rolled Mockito {@link Context} pattern established by
 * {@link V2SchemaInferControllerTest}. No {@code JavalinTest}.
 */
class V2ScalarDbCatalogControllerTest {

    private static final ObjectMapper MAPPER = new ObjectMapper();

    private TransactionFactory factory;
    private DistributedTransactionAdmin admin;
    private V2ScalarDbCatalogController controller;
    private Context ctx;
    ...
    void setUp() {
        ...
        controller = new V2ScalarDbCatalogController(factory);
    ...
    void happyPath_nestsNamespacesTablesColumns_withFullKeyClassification() throws Exception {
        ...
        when(admin.getNamespaceTableNames("app"))
                .thenReturn(new LinkedHashSet<>(List.of("users")));
        ...
        assertEquals("BIGINT", idCol.get("type").asText(),
        ...
        assertFalse(ageCol.has("keyType"),
    ...
    void multipleNamespacesAndTables_allIterated() throws Exception {
        ...
        when(admin.getTableMetadata(any(String.class), any(String.class)))
                .thenReturn(simpleMeta);
    ...
    void adminThrowsExecutionException_mapsToServiceUnavailable() throws Exception {
        when(admin.getNamespaceNames())
                .thenThrow(new ExecutionException("connection refused"));
