...
class ValidationEngineTest {
    ...
    void textRequired_missingValue_returnsError() {
        String json =
                projectionWithData(
                        sectionWithElement(
                                "\"constraint\":{\"constraintType\":\"text\",\"charType\":\"any\",\"required\":true}"),
                        "{}");
    ...
    void textMaxLength_exceeded_returnsError() {
        String json =
                projectionWithData(
                        sectionWithElement(
                                "\"constraint\":{\"constraintType\":\"text\",\"charType\":\"any\",\"maxLength\":3}"),
                        "{\"name\":\"toolong\"}");
    ...
    void textMaxLength_withinLimit_passes() {
        String json =
                projectionWithData(
                        sectionWithElement(
                                "\"constraint\":{\"constraintType\":\"text\",\"charType\":\"any\",\"maxLength\":10}"),
                        "{\"name\":\"ok\"}");
        assertTrue(ValidationEngine.validate(json).isEmpty());
    }
    ...
    void textInputPattern_nonMatching_returnsError() {
        String json =
                projectionWithData(
                        sectionWithElement(
                                "\"constraint\":{\"constraintType\":\"text\",\"charType\":\"any\","
    ...
    void numeric_belowMin_returnsError() {
        String json =
                projectionWithData(
                        sectionWithElement(
                                "\"constraint\":{\"constraintType\":\"numeric\","
    ...
    void date_beforeRange_returnsError() {
        String json =
                projectionWithData(
                        sectionWithElement(
                                "\"constraint\":{\"constraintType\":\"date\","
    ...
    void codeSet_valueNotInSet_returnsError() {
        String json =
                projectionWithData(
                        sectionWithElement(
                                "\"constraint\":{\"constraintType\":\"codeSet\","
                                        + "\"codeSet\":[\"01\",\"02\",\"03\"]}"),
                        "{\"name\":\"99\"}");
        assertEquals(1, ValidationEngine.validate(json).size());
    }
