 ...
 *
 * <p>Emits a single SLF4J line per operation attempt. Using a shared helper
 * ensures that all Phase 1.5+ controllers produce identically-shaped log
 * lines, making it easy to grep for a correlation ID across phases.
 *
 * <p>Usage:
 * <pre>{@code
 ...
 * <ul>
 *   <li>{@code "create_table"} — Phase 1.5</li>
 *   <li>{@code "evaluate"} — Phase 2 (future)</li>
 *   <li>{@code "projection_write"} — Phase 2 (future)</li>
 * </ul>
 */
    ...
    public static void op(
        ...
        if ("created".equals(outcome)) {
            log.info(
                ...
                operation, userId, namespace, tableName, outcome, correlationId);
        } else {
            log.warn(
                "AUDIT op={} user={} ns={} table={} outcome={} correlationId={}",
                operation, userId, namespace, tableName, outcome, correlationId);
