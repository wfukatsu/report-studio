 ...
 *
 * <p>Schema files are stored in {@code classpath:schemas/e-tax/} and mapped
 * by {@code schemaVersion} string. The version key comes from
 * {@link com.report.server.FlatSubmissionModel#schemaVersion()}.
 *
 * <h3>Adding the official NTA XSD</h3>
 * <ol>
 *   <li>Download the {@code .cab} from:
 *       {@code https://www.e-tax.nta.go.jp/shiyo/shiyo-withholding3.htm}</li>
 *   <li>Extract the XSD (e.g. {@code PGE2025-231.xsd}).</li>
 *   <li>Save it to:
 *       {@code server/src/main/resources/schemas/e-tax/withholding-tax-2025.xsd}</li>
 *   <li>Add the mapping in {@link #SCHEMA_VERSIONS} below.</li>
 * </ol>
 *
 * <h3>Security</h3>
 * <ul>
 *   <li>External access (DTD, stylesheet) is disabled on the {@link SchemaFactory}.</li>
 *   <li>Schemas are compiled once per version and cached in {@link #SCHEMA_CACHE}.</li>
 * </ul>
 */
public final class EtaxXmlValidator {
    ...
    private static final Map<String, String> SCHEMA_VERSIONS = Map.of(
        "stub-1.0",   "schemas/e-tax/withholding-tax-stub.xsd"
        // To add 2025 official: "withholding-tax-2025", "schemas/e-tax/withholding-tax-2025.xsd"
    );
    ...
    public static void validate(Document doc, String schemaVersion) throws XmlValidationException {
        ...
        if (resourcePath == null) {
            throw new IllegalArgumentException(
                "No XSD registered for schemaVersion '" + schemaVersion + "'. " +
        ...
        try {
            ...
            throw new XmlValidationException(schemaVersion, "Validator error: " + e.getMessage(), e);
        }
    }
    ...
    private static Schema loadSchema(String resourcePath) {
        try {
            ...
            InputStream is = EtaxXmlValidator.class.getClassLoader().getResourceAsStream(resourcePath);
            if (is == null) {
                throw new IllegalStateException("XSD resource not found on classpath: " + resourcePath);
            }
            try (is) {
