 ...
 *
 * <p>Mirrors the frontend RevenueStampRenderer (src/elements/revenueStamp/
 * Renderer.tsx): bordered box with a light background, optional 収入印紙
 * label (top-left), optional amount (bottom-right), and an optional dashed
 * vertical cancellation guide through the center.
 */
    ...
    public void render(PDPageContentStream cs, JsonNode el, float x, float y,
        ...
        try {
            ...
            if (!amount.isEmpty()) {
                ...
                cs.newLineAtOffset(x + w - textWidth - 1.5f * MM_TO_PT,
