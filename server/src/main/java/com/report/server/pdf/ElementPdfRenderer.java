...
/**
 * Interface for element-kind-specific PDF rendering. Each implementation handles one element kind
 * (text, shape, barcode, etc.).
 *
 * <p>fontCache is passed per-template to avoid thread-safety issues when the registry is shared
 * across concurrent batch jobs.
 */
