 ...
 *
 * <p>Mirrors the frontend DividerRenderer (src/elements/divider/Renderer.tsx): a horizontal divider
 * draws through the vertical center of the frame, a vertical one through the horizontal center.
 * Dash patterns match the frontend's mm-based map (dashed = 4mm/2mm, dotted = 1mm/1mm).
 */
